  ...
  public function get_content($req, $reqval) {
    ...
    switch ($req) {
        ...
        case "blockhash":
          ...
          $this->html_content_string .= "<h2><i class='fa fa-cube fa-fw' aria-hidden='true'></i> Block <small id='block.hash' style='word-break: break-all;'>" . $reqval . "</small></h2>" .
            "<div class='row'>";
              "<div class='col-md-6 stats'>" .
                "<div><span data-toggle='tooltip' data-placement='right' data-original-title='Block index in the chain, counting from zero (i.e. genesis block).'><i class='fa fa-question-circle'></i></span> Height: <span id='block_height'><span id='block.height'>" . $this->block->getheight($reqval) . "</span></span></div>" .
                  ...
                  "<div class='panel-body'>" .
                    "<div class='table-responsive'>" .
                      ...
                      "<tbody id='mem_pool_rows'>" .
                        $this->gettransactionslist($this->block) .
                      "</tbody>" .
                      "</table>" .
                    "</div>" .
                  "</div>" .
